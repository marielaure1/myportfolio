                ...
                <div className="w-full box-border grid grid-cols-3 auto-rows-[13vw] gap-[20px]">
                    <div className="card-projet row-span-3 border-b-4 border-black relative">
                        ...
                        <div className="absolute bottom-0 left-0 w-full p-5">
                            <h2 className="uppercase font-semibold text-lg">Nom</h2>
                            <p className="uppercase font-semibold text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laborum, tempora?</p>
                        </div>
                    </div>
