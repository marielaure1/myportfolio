        ...
        <>
            ...
            <section className="w-full px-[5vw] pb-[5vw]">
                <div className="w-full box-border grid  grid-cols-3 auto-rows-[13vw] gap-[20px]">
                    <div className="card-projet bg-red-800 row-span-3 border-b-2 border-solid border-black"></div>
                    <div className="card-projet bg-red-800 row-span-2 border-b-2 border-solid border-black"></div>
                    <div className="card-projet bg-red-800 row-span-3 border-b-2 border-solid border-black"></div>
                    <div className="card-projet bg-red-800 row-span-3 border-b-2 border-solid border-black"></div>
                    <div className="card-projet bg-red-800 row-span-2 border-b-2 border-solid border-black"></div>
                    <div className="card-projet bg-red-800 row-span-3 border-b-2 border-solid border-black"></div>
