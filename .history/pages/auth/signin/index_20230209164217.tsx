...
export const SigninPage: NextPage = () => {
    ...
    return (
        <form onSubmit={onSubmit}>
            ...
            <label htmlFor="password">Mot de asse:</label>
            <input type="text" name="password" id="password" value="{credentials.password}" onChange={(e) => setCredentials({ ...credentials, username: e.target.value})}/>
        </form>
    )
}
