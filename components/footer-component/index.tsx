        ...
        <>
            <footer className="flex w-full border-t border-solid border-black">
               <div className="sm:grid grid-cols-3 px-[5vw] w-full">
                    <div className="links py-7 flex sm:flex-row flex-col sm:mb-0 mb-4 sm:border-r border-dashed border-black">
                        <div className="sm:w-1/2">
                            <Link href="/" className="uppercase text-md sm:mb-3 block">Accueil</Link>
                            <Link href="/projets" className="uppercase text-md sm:mb-3 block">Projets</Link>
                            <Link href="/a-propos" className="uppercase text-md sm:mb-3 block">A propos</Link>
                        </div>
                        <div className="sm:w-1/2">
                            <Link href="/contact" className="uppercase text-md sm:mb-3 block">Contact</Link>
                            <Link href="/mentions-legales" className="uppercase text-md sm:mb-3 block">Mentions Légales</Link>
                        </div>
                    </div>
                    <div className="logo flex items-center justify-center sm:mb-0 mb-4 sm:border-r border-dashed border-black">
                        <Link href="/">
                    ...
                    <div className="coords py-7 text-end">
                        <h3 className="uppercase text-md mb-1">Coordonnées</h3>
                        <Link href="mailTo:edjour.marielaure@gmail.com" className="text-md mb-2 block">edjour.marielaure@gmail.com</Link>
